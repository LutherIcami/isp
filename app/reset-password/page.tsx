    ...
    if (!token) {
        return (
            <div className="text-center bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl">
                ...
                <Link href="/login" className="inline-flex items-center gap-2 font-bold text-indigo-600 hover:text-indigo-700">
        ...
        <div className="w-full max-w-md">
            ...
            {success ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 px-1 uppercase tracking-widest text-[10px]">New Password</label>
                    ...
                    <div>
                        <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 px-1 uppercase tracking-widest text-[10px]">Confirm New Password</label>
                        <div className="relative">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                            <input
                                type="password"
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 p-12 flex-col justify-between relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    <h2 className="text-5xl font-extrabold text-white leading-tight mb-6">
                        Secure <br /> your identity.
                    </h2>
                    <p className="text-white/70 text-lg max-w-md">
                        Your security is our priority. Choose a strong password to protect your account data.
                    </p>
                </div>
